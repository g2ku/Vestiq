    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 bg-slate-50 dark:bg-slate-900">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Вход в аккаунт</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-2">Войдите, чтобы управлять подпиской</p>
        </div>
